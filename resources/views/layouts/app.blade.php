    ...
    <header class="p-5 border-b bg-white shadow">
        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            <nav class="flex gap-4 items-center">
                ...
                <a href="{{ route('posts.create') }}" class="flex items-center gap-2 bg-indigo-500 hover:bg-indigo-600 border p-2 text-gray-100 rounded-md text-sm  shadow-2xl uppercase font-bold cursor-pointer ">
            ...
            @guest
            <nav class="flex gap-4 items-center">
                <a href="{{ route('login') }}" class="font-bold text-gray-600 uppercase text-sm ">Login</a>
